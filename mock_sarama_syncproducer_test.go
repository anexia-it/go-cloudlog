...
func (_m *MockSyncProducer) SendMessage(_param0 *sarama.ProducerMessage) (int32, int64, error) {
...
func (_m *MockSyncProducer) SendMessages(_param0 []*sarama.ProducerMessage) error {
	ret := _m.ctrl.Call(_m, "SendMessages", _param0)
	ret0, _ := ret[0].(error)
	return ret0
}
