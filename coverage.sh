...
go test -v -coverprofile=${GO_CLOUDLOG_COVERAGE_TMP}/go_cloudlog_structencoder.coverage ./structencoder
...
egrep -v '^mode:' ${GO_CLOUDLOG_COVERAGE_TMP}/go_cloudlog_structencoder.coverage \
    >> ${GO_CLOUDLOG_COVERAGE_TMP}/combined.coverage
